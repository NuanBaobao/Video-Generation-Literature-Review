...
## 2602
- [Causal Forcing: Autoregressive Diffusion Distillation Done Right for High-Quality Real-Time Interactive Video Generation](https://arxiv.org/abs/2602.02214)
...
- [SSVAE：Delving into Latent Spectral Biasing of Video VAEs for Superior Diffusability](https://arxiv.org/abs/2512.05394)
...
## 2505
- [MAGI-1: Autoregressive Video Generation at Scale](https://arxiv.org/abs/2505.13211)

## 2504
- [SkyReels-V2: Infinite-length Film Generative Model](https://arxiv.org/abs/2504.13074)
...
- [Pyramidal Flow Matching for Efficient Video Generative Modeling](https://arxiv.org/pdf/2410.05954)
...
[https://arxiv.org/abs/2602.02214](https://arxiv.org/abs/2602.02214)
...
[https://arxiv.org/abs/2512.05394](https://arxiv.org/abs/2512.05394)

**视频生成中的 VAE latent space 到底应该具备什么结构，才能让后续 diffusion / flow-matching 训练更容易****？**


<p align="center">
<img src="https://cdn.nlark.com/yuque/0/2026/png/26304400/1779280668320-14b60376-6443-4f43-b344-03413384b453.png" width="50%">
</p>


**SSVAE 这篇文章研究的是视频 VAE latent space 的 diffusability，即它是否容易被后续 diffusion / flow backbone 学习。作者通过统计分析发现，适合生成的视频 VAE latent 具有两个重要结构：第一，spatio-temporal frequency spectrum 应该偏向低频，这样 latent 更平滑，diffusion 更容易恢复结构和细节；第二，channel-wise eigenspectrum 应该由少数 modes 主导，即 few-mode bias，这可以加快 diffusion 在主要相关模式上的收敛。基于这两个发现，作者提出 LCR，通过提高局部时空相关性增强低频 bias；以及 LMR，通过 latent masked reconstruction 同时促进 few-mode bias 和 decoder robustness。实验表明，SSVAE 虽然 reconstruction 指标略降，但显著提升 text-to-video 生成质量，在 17×512×512 任务上实现约 3× 收敛加速，并且 1.3B backbone 可超过 Wan 2.2 VAE + 4B backbone。**
...
[https://arxiv.org/abs/2505.13211](https://arxiv.org/abs/2505.13211)

# 2504
## SkyReels-V2: Infinite-length Film Generative Model
[https://arxiv.org/abs/2504.13074](https://arxiv.org/abs/2504.13074)
